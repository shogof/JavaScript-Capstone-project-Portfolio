let user = document.getElementById("perview");
...
// No need for the linkImages function in this context
...
const projectCard = [
  ...
  },
  {
    ...
    descriptionLong1:
      "🚀 As a diligent web development enthusiast, I've dedicated numerous hours to refining my skills in remote development.",
    language1: "HTML",
    language2: "CSS",
    language3: "JavaScript",
